		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
			...
			<div class="space-y-4 md:col-span-2">
				...
				<div class="flex items-center gap-3 pt-2">
					<!-- Facebook -->
					<a
						href={SITE_INFO.social?.facebook || 'https://www.facebook.com/profile.php?id=61573051238563'}
						target="_blank"
					...
					<!-- YouTube -->
					<a
						href={SITE_INFO.social?.youtube || 'https://www.youtube.com/@canadanepalfriends3222'}
						target="_blank"
						rel="noopener noreferrer"
